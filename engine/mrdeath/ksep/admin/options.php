...
$options .= ShowItem('options[cookie_saves]', 'Использовать кукисы?', 'Работает только с версии Advanced Kodik Parser 4.5.0 и выше. При включении можно выводить просмотренное время и озвучку пользователем, будут доступны теги {episode-currenttime},{episode-currentvoice},{episode-duration}, {episode-progress}, [episode-currenttime], [episode-currentvoice], [episode-duration], [episode-progress] и их not версии.', $series_options['cookie_saves'], 'checkbox');
