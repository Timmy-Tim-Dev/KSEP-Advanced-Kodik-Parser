        ...
        <div class="row box-section">
            ...
            <div class="col-sm-6 media-list media-list-linked">
                <a class="media-link" href="?mod={$mod}&action=fields">
                    <div class="media-left">
                        <img src="public/adminpanel/images/xfset.png" class="img-lg section_icon">
                    </div>
        ...
        <div class="row box-section">
            <div class="col-sm-6 media-list media-list-linked">
                <a class="media-link" href="?mod={$mod}&action=massgeneration">
                    <div class="media-left">
                        <img src="public/adminpanel/images/refresh.png" class="img-lg section_icon">
                    </div>
            ...
            <div class="col-sm-6 media-list media-list-linked">
                <a class="media-link" href="?mod={$mod}&action=faq">
                    <div class="media-left">
                        <img src="public/adminpanel/images/question.png" class="img-lg section_icon">
                    </div>
